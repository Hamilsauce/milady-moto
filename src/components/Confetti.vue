...
// const confetti = ref.confetti.getElementById("confetti") as HTMLCanvasElement;
//@ts-ignore
const confettiCtx = confetti.getContext("2d") as CanvasRenderingContext2D;
let container: any;
...
function updateConfetti(number?: number) {
...
<template>
  <canvas ref="confetti" id="confetti"></canvas>
</template>
